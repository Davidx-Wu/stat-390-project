...
DATA_PATH = REPO / "data" / "processed" / "gonzaga_speech_dataset_v1.csv"
OUT_DIR = REPO / "results" / "gonzaga" / "baseline_runs"
METRICS_OUT = OUT_DIR / "baseline_v3_structured_numeric_metrics.csv"
COEFFICIENTS_OUT = OUT_DIR / "baseline_v3_structured_numeric_coefficients.csv"
...
def main():
    ...
    print("Baseline v3: structured numeric logistic regression")
