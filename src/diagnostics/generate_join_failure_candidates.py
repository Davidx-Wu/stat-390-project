...
def load_parser(repo_root: Path):
    path = repo_root / "src" / "parsing" / "debate_doc_parser.py"
...
def main() -> int:
    ...
    failed_list = repo / "results" / "gonzaga" / "legacy_baseline_model" / "failed_files.txt"
    tab_csv = repo / "data" / "raw" / "9 -- Build Gonzaga Dataset" / "Gonzaga_Tabroom-prelims_table.csv"
    base_docs = repo / "data" / "raw" / "9 -- Build Gonzaga Dataset"
    out_csv = repo / "results" / "gonzaga" / "legacy_baseline_model" / "join_failure_candidates.csv"
