...
V1_PATH = REPO / "data" / "processed" / "gonzaga_speech_dataset_v1.csv"
CARD_AUDIT_PATH = REPO / "results" / "gonzaga" / "parser_output" / "card_audit_all.csv"
ARGUMENT_AUDIT_PATH = REPO / "results" / "gonzaga" / "parser_output" / "argument_audit_all.csv"
OUT_PATH = REPO / "data" / "processed" / "gonzaga_speech_dataset_v2_with_text.csv"
