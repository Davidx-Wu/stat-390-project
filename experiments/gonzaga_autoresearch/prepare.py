...
DATA_PATH = REPO / "data" / "processed" / "gonzaga_speech_dataset_v2_with_text.csv"
RANKINGS_PATH = REPO / "data" / "raw" / "9 -- Build Gonzaga Dataset" / "gonzaga_dataset_output" / "Shirley_Rankings.csv"
...
def log_result(experiment_id, metrics, status, description):
    """Append one experiment row to experiments/gonzaga_autoresearch/results.tsv."""
