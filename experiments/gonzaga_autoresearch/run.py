...
Run one experiment:
    ...
    python experiments/gonzaga_autoresearch/run.py "try interaction features"
"""
import subprocess
import sys
import time
...
def main():
    ...
    plot_results()
    print(f"Result logged to experiments/gonzaga_autoresearch/results.tsv (status={status})")
