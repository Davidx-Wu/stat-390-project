...
NDT_ROOT = REPO_ROOT / "1 -- data" / "raw" / "8 -- Keep Only Tournament Docs" / "ndtceda25"
PARSER_PATH = SCRIPTS / "debate_doc_parser_vF.py"
NORTHWESTERN_TABROOM = DATA_RAW / "Northwestern_Tabroom-prelims_table.csv"
GONZAGA_SOURCE = REPO_ROOT / "4 -- results" / "processed_datasets" / "gonzaga_speech_dataset_v1.csv"
